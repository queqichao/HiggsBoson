...
if __name__ == "__main__":
    ...
    path = ""
    solutionFile = "/users/qichaoque/Documents/kaggle/higgs-boson/data/test.csv"
    submissionFile = "/users/qichaoque/Documents/kaggle/higgs-boson/random_submission.csv"
